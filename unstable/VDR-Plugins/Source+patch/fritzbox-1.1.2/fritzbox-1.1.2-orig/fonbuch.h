...
private:
	...
	eType type;
public:
	cFonbuchEntry(std::string &name, std::string &number, eType type = TYPE_NONE);
...
public:
	 ...
	 */
	virtual std::string ResolveToName(std::string &number);
	/**
	 ...
	 */
	virtual cFonbuchEntry *RetrieveFonbuchEntry(size_t id);
	/**
