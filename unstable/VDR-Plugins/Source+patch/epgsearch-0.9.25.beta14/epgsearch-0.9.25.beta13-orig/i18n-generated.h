...
// START I18N - automatically generated by pot2i18n.pl
  ...
  { "Direct access to epgsearch's search menu",
    ...
    "",
    "Acceso directo al men˙ de b˙squeda EPGSearch",
    "",
    "",
    "",
    "",
  ...
  { "Help$Hides the main menu entry and may be useful if this plugin is used to replace the original 'Schedule' entry.",
    ...
    "",
    "Nascondere la voce nel menu puÚ essere utile se questo plugin Ë usato per sostituire la voce originale 'Programmi'",
  ...
  { "Help$When VDR is patched to allow this plugin to replace the original 'Schedule' entry, you can de/activate this replacement here.",
    ...
    "",
    "Quando VDR Ë patchato per permettere a questo plugin di sostituire la voce originale 'Programmi', puoi dis/attivare qui la sostituzione.",
  ...
  { "Help$Choose between 'Overview - Now' and 'Schedule' as start menu when this plugin is called.",
    ...
    "",
    "Scegli tra 'Sommario - Adesso' e 'Programmi' come menu iniziale quando questo plugin Ë chiamato.",
  ...
  { "Help$When a timer is created with 'Record' you can choose between an immediate creation of the timer or the display of the timer edit menu.",
    ...
    "",
    "Quando un timer Ë creato con 'Registra' puoi selezionare tra una creazione immediata del timer o la visualizzazione del menu modifica timer.",
  ...
  { "Help$Choose 'yes' here if you want to display channels without EPG in 'Overview - Now'. 'Ok' on these entries switches the channel.",
    ...
    "",
    "Scegli 'sÏ' se vuoi vedere i canali senza EPG in 'Sommario - Adesso'. 'Ok' in questi valori cambia il canale.",
  ...
  { "Help$A favorites menu can display a list of your favorite broadcasts. Enable this if you want an additional menu besides 'Now' and 'Next'\nAny search can be used as a favorite. You only have to set the option 'Use in favorites menu' when editing a search.",
    ...
    "",
    "Un menu preferiti puÚ mostrare un elenco delle tue trasmissioni preferite. Abilitalo se vuoi un menu supplementare in 'Adesso' e 'Prossimi'\nQualsiasi ricerca puÚ essere usata come preferita. Devi solo impostare l'opzione 'Utilizza nel menu preferiti' quando modifichi una ricerca.",
  ...
  { "Help$Besides 'Now' and 'Next' you can specify up to 4 other times in the EPG which can be used by repeatedly pressing the green key, e.g. 'prime time', 'late night',...",
    ...
    "",
    "All'interno di 'Adesso' e 'Prossimi' puoi specificare fino ad altre 4 ore nell'EPG che puÚ essere usato ripetutamente premendo il tasto verde, esempio 'prima serata', 'tarda sera',...",
  ...
  { "Help$This is the description for your user-defined time as it will appear as label on the green button.",
    ...
    "",
    "Questa Ë la descrizione dell'ora definita dall'utente che apparir‡ come etichetta nel pulsante verde.",
  ...
  { "Help$'Search timers' can be used to automatically create timers for events that match your search criterions.",
    ...
    "",
    "'Cerca timer' puÚ essere usato per creare automaticamente timer per eventi che corrispondano a criteri di ricerca.",
  ...
  { "Help$Specify here the default priority of timers created with this plugin. This value can also be adjusted for each search itself.",
    ...
    "",
    "Specifica qui la priorit‡ predefinita dei timer creati con questo plugin. Questo valore puÚ anche essere adattato per ciascuna ricerca.",
  ...
  { "Help$Specify here the default lifetime of timers/recordings created with this plugin. This value can also be adjusted for each search itself.",
    ...
    "",
    "Specifica qui la durata predefinita dei timer/registrazioni creati con questo plugin. Questo valore puÚ anche essere adattato per ciascuna ricerca.",
  ...
  { "Help$Specify here the default start recording margin of timers/recordings created with this plugin. This value can also be adjusted for each search itself.",
    ...
    "",
    "Specifica qui il margine predefinito di inizio della registrazione dei timer/registrazioni creati con questo plugin. Questo valore puÚ anche essere adattato per ciascuna ricerca.",
  ...
  { "Help$Specify here the default stop recording margin of timers/recordings created with this plugin. This value can also be adjusted for each search itself.",
    ...
    "",
    "Specifica qui il margine predefinito di fine registrazione dei timer/registrazioni creati con questo plugin. Questo valore puÚ anche essere adattato per ciascuna ricerca.",
  ...
  { "Help$Set this to 'yes' if you don't like to get any announcements of broadcasts if you currently replay anything.",
    ...
    "",
    "Imposta 'sÏ' se non ti piace avere degli annunci dalle emittenti se stai attualmente riproducendo qualcosa.",
  ...
  { "Help$Set this to 'yes' if you want timers to be recreated with the next search timer update after deleting them.",
    ...
    "",
    "Imposta 'sÏ' se vuoi ricreare i timer con la successiva ricerca di aggiornamento timer dopo la loro eliminazione.",
  ...
  { "Help$Set this to 'yes' if don't want to see events on PayTV channels when searching for repeats.",
    ...
    "",
    "Imposta 'sÏ' se non vuoi vedere gli eventi dei canali a pagamento durante la ricerca delle repliche.",
  ...
  { "Help$If a timer with priority below the given value will fail it will not be classified as important. Only important conflicts will produce an OSD message about the conflict after an automatic conflict check.",
    ...
    "",
    "Se un timer con priorit‡ pi˘ bassa di un dato valore fallir‡ esso non sar‡ classificato come importante. Solo i conflitti importanti genereranno un messaggio OSD sul conflitto dopo una verifica automatica del conflitto.",
  ...
  { "Help$If a conflicts duration is less then the given number of minutes it will not be classified as important. Only important conflicts will produce an OSD message about the conflict after an automatic conflict check.",
    ...
    "",
    "Se la durata di un conflitto Ë inferiore al numero di minuti dati non sar‡ classificato come importante. Solo i conflitti importanti genereranno un messaggio OSD sul conflitto dopo la verifica automatica di ciascun conflitto.",
  ...
  { "Help$Set this to 'yes' if the conflict check should be performed after each manual timer programming. In the case of a conflict you get immediately a message that informs you about it. The message is only displayed if this timer is involved in any conflict.",
    ...
    "",
    "Imposta 'sÏ' se il controllo di conflitto dovrebbe essere eseguito dopo la programmazione di ciascun timer manuale. Nel caso di un conflitto avrai immediatamente un messaggio che ti informa di questo. Il messaggio viene visualizzato solo se questo timer Ë coinvolto in qualche conflitto.",
  ...
  { "Help$Set this to 'yes' if the conflict check should be performed when a recording starts. In the case of a conflict you get immediately a message that informs you about it. The message is only displayed if the conflict is within the next 2 hours.",
    ...
    "",
    "Imposta 'sÏ' se il controllo di conflitto dovrebbe essere eseguito dopo l'inizio di una registrazione. Nel caso di un conflitto avrai immediatamente un messaggio che ti informa di questo. Il messaggio viene visualizzato solo se questo conflitto avviene nelle prossime 2 ore.",
  ...
  { "Help$Set this to 'yes' if the conflict check should be performed after each search timer update.",
    ...
    "",
    "Imposta 'sÏ' se la verifica del conflitto dovrebbe essere eseguita dopo ciascun aggiornamento del timer di ricerca.",
  ...
  { "Help$If the next conflict will appear in the given number of minutes you can specify here a shorter check intervall to get more OSD notifications about it.",
    ...
    "",
    "Se il prossimo conflitto comparir‡ nel numero dato di minuti puoi specificare qui un intervallo di verifica pi˘ breve per avere pi˘ notifiche OSD su di esso.",
  ...
  { "Help$Set this to 'yes' if the don't want to get OSD messages about conflicts if you currently replay something. Nevertheless messages will be displayed if the first upcoming conflict is within the next 2 hours.",
    ...
    "",
    "Imposta 'sÏ' se non vuoi avere messaggi OSD sui conflitti se stai riproducendo qualcosa. Tuttavia i messaggi saranno visualizzati se il primo conflitto avviene entro le prossime 2 ore.",
  ...
  { "Help$Set this to 'yes' if you want to get an email notification about the search timers that where programmed automatically in the background.",
    ...
    "",
    "Imposta 'sÏ' se vuoi avere una email di notifica sui timer di ricerca che sono stati programmati automaticamente dal sistema.",
  ...
  { "Help$Set this to 'yes' if you want to get an email notification about the timer conflicts.",
    ...
    "",
    "Imposta 'sÏ' se vuoi avere una notifica email sui timer in conflitto.",
  ...
  { "Help$Set this to 'yes' if your account needs authentication to send mails.",
    ...
    "",
    "Imposta 'sÏ' se il tuo account ha bisogno di autenticazione per inviare email.",
  ...
  { "Help$Specify the auth user, if this account needs authentication for SMTP.",
    ...
    "",
    "Si Èsta cuenta necesita autenticaciÛn SMTP, especifique el usuario.",
    "",
    "",
    "",
    "",
  ...
  { "Help$Specify the auth password, if this account needs authentication for SMTP.",
    ...
    "",
    "Si Èsta cuenta necesita autenticaciÛn SMTP, especifique la contraseÒa.",
    "",
    "",
    "",
    "",
  ...
  { "$ abcdefghijklmnopqrstuvwxyz0123456789-.,#~\\^$[]|()*+?{}/:%@&",
    ...
    " abcdefghijklmnopqrstuvwxyz0123456789-.,#~\\^$[]|()*+?{}/:%@&",
    " a‡bcdeÈËfghiÓÏjklmnoÚpqrstu˘vwxyz0123456789-.#~\\^$[]|()*+?{}/:%",
    " abcdefghijklmnopqrstuvwxyz0123456789-.,#~\\^$[]|()*+?{}/:%@&",
    "",
    ...
    "",
    " a·bcdeÈfghiÌjklmnÒoÛpqrstu˙vwxyz0123456789-.,#~\\^$[]|()*+?{}/:%@&",
    "",
    "",
    "",
  ...
  { "Start/Stop time has changed",
    ...
    "",
    "L'orario di Inizio/Fine Ë cambiato",
    "",
    "",
  ...
  { "Edit$Search text too short - use anyway?",
    ...
    "",
    "Il testo da cercare Ë troppo corto - continuare?",
  ...
  { "Help$Set this to 'Yes' if your search should match the case.",
    ...
    "",
    "Imposta 'SÏ' nel caso la ricerca dovesse corrispondere.",
  ...
  { "Help$Set this to 'Yes' if you like to search in the title of an event.",
    ...
    "",
    "Imposta 'SÏ' se vuoi cercare il titolo di un evento.",
  ...
  { "Help$Set this to 'Yes' if you like to search in the episode of an event.",
    ...
    "",
    "Imposta 'SÏ' se vuoi cercare l'episodio di un evento.",
  ...
  { "Help$Set this to 'Yes' if you like to search in the summary of an event.",
    ...
    "",
    "Imposta 'SÏ' se vuoi cercare il sommario di un evento.",
  ...
  { "Help$The summary of an event, can contain additional information like 'Genre', 'Category', 'Year',... called 'EPG categories' within EPGSearch. External EPG providers often deliver this information. This allows refining a search and other nice things, like searching for the 'tip of the day'. To use it set this to 'Yes'.",
    ...
    "",
    "Il sommario di un evento, puÚ contenere informazione addizionale come 'Genere', 'Categoria', 'Anno',... chiamata 'Categorie EPG' all'interno di EPGSearch. I fornitori di EPG esterni spesso inviano questa informazione. Questo ti permette di rifinire una ricerca e altre cosette, come la ricerca per il 'consiglio del giorno'. Per usarlo imposta 'SÏ'.",
  ...
  { "Help$The file epgsearchcats.conf specifies the search mode for this entry. One can search by text or by value. You can also edit a list of predefined values in this file that can be selected here.",
    ...
    "",
    "Il file epgsearchcats.conf specifica la modalit‡ di ricerca per questo valore. Uno puÚ cercare per testo o per valore. Puoi anche modificare un elenco di valori predefiniti in questo file che puÚ essere qui selezionato.",
  ...
  { "Help$If a selected category is not part of the summary of an event this normally excludes this event from the search results. To avoid this, set this option to 'Yes', but please handle this with care to avoid a huge amount of results.",
    ...
    "",
    "Se una categoria selezionata non Ë parte del sommario di un evento questo normalmente esclude questo evento dai risultati di ricerca. Per evitare ciÚ, imposta 'SÏ' come opzione, ma gestiscilo con attenzione per evitare una grande quantit‡ di risultati.",
    ...
    "",
    "Si una categorÌa seleccionada no es parte del resumen de una emisiÛn, normalmente esta no incluye ese evento en los resultados de la b˙squeda. Para evitarlo establezca esta opciÛn a 'SÌ', pero maneje esto con cuidado para evitar una gran cantidad de resultados.",
    "",
    "",
    "",
    "",
