...
void cMenuSetupGeneral::Set()
{
  ...
  Add(new cMenuEditBoolItem(tr("Replace original schedule"),    &data->ReplaceOrgSchedule, tr("no"),      tr("yes")));
...
void cMenuSetupEPGMenus::Set()
{
    ...
    Add(new cMenuEditBoolItem(  tr("Show channel numbers"), &data->showChannelNr,       tr("no"),      tr("yes")));
    AddHelp(tr("Help$Display channel numbers in 'Overview - Now'.\n\n(To completely define your own menu look please inspect the MANUAL)"));
    Add(new cMenuEditBoolItem(  tr("Show channel separators"), &data->showChannelGroups,       tr("no"),      tr("yes")));
    AddHelp(tr("Help$Display VDR channel groups as separators between your channels in 'Overview - Now'."));
    Add(new cMenuEditBoolItem(  tr("Show day separators"), &data->showDaySeparators,       tr("no"),      tr("yes")));
    AddHelp(tr("Help$Display a separator line at day break in 'Schedule'."));
    Add(new cMenuEditBoolItem(  tr("Show radio channels"), &data->showRadioChannels,       tr("no"),      tr("yes")));
    ...
    Add(new cMenuEditBoolItem(  tr("'One press' timer creation"), &data->onePressTimerCreation,       tr("no"),      tr("yes")));
    ...
    Add(new cMenuEditBoolItem(  tr("Show channels without EPG"), &data->showEmptyChannels,       tr("no"),      tr("yes")));
...
eOSState cMenuSetupEPGMenus::ProcessKey(eKeys Key)
{
    int iTemp_showProgress = data->showProgress;
    int iTemp_showFavoritesMenu = data->showFavoritesMenu;
    ...
    if (iTemp_showProgress != data->showProgress ||
	iTemp_showFavoritesMenu != data->showFavoritesMenu)
    {
	Set();
	Display();
    }
...
void cMenuSetupUserdefTimes::Set()
{
  ...
  Add(new cMenuEditBoolItem(szUseUserTime, &data->ShowModes[showUserMode1].useIt,       tr("no"),      tr("yes")));
  ...
  {
      Add(new cMenuEditStrItem(IndentMenuItem(tr("Description")), data->ShowModes[showUserMode1].description, sizeof(data->ShowModes[showUserMode1].description), tr(FileNameChars)));
  ...
  Add(new cMenuEditBoolItem( szUseUserTime, &data->ShowModes[showUserMode2].useIt,       tr("no"),      tr("yes")));
  AddHelp(tr("Help$Besides 'Now' and 'Next' you can specify up to 4 other times in the EPG which can be used by repeatedly pressing the green key, e.g. 'prime time', 'late night',..."));
  if (data->ShowModes[showUserMode2].GetUsage())
  {
      Add(new cMenuEditStrItem(IndentMenuItem(tr("Description")), data->ShowModes[showUserMode2].description, sizeof(data->ShowModes[showUserMode2].description), tr(FileNameChars)));
      AddHelp(tr("Help$This is the description for your user-defined time as it will appear as label on the green button."));
  ...
  Add(new cMenuEditBoolItem(szUseUserTime, &data->ShowModes[showUserMode3].useIt,       tr("no"),      tr("yes")));
  AddHelp(tr("Help$Besides 'Now' and 'Next' you can specify up to 4 other times in the EPG which can be used by repeatedly pressing the green key, e.g. 'prime time', 'late night',..."));
  if (data->ShowModes[showUserMode3].GetUsage())
  {
      Add(new cMenuEditStrItem(IndentMenuItem(tr("Description")), data->ShowModes[showUserMode3].description, sizeof(data->ShowModes[showUserMode3].description), tr(FileNameChars)));
      AddHelp(tr("Help$This is the description for your user-defined time as it will appear as label on the green button."));
  ...
  Add(new cMenuEditBoolItem(szUseUserTime, &data->ShowModes[showUserMode4].useIt,       tr("no"),      tr("yes")));
  AddHelp(tr("Help$Besides 'Now' and 'Next' you can specify up to 4 other times in the EPG which can be used by repeatedly pressing the green key, e.g. 'prime time', 'late night',..."));
  if (data->ShowModes[showUserMode4].GetUsage())
  {
      Add(new cMenuEditStrItem(IndentMenuItem(tr("Description")), data->ShowModes[showUserMode4].description, sizeof(data->ShowModes[showUserMode4].description), tr(FileNameChars)));
      AddHelp(tr("Help$This is the description for your user-defined time as it will appear as label on the green button."));
...
void cMenuSetupTimers::Set()
{
  ...
  Add(new cMenuEditBoolItem(  tr("Use VDR's timer edit menu"),         &data->useVDRTimerEditMenu,       tr("no"),      tr("yes")));
...
void cMenuSetupSearchtimers::Set()
{
  ...
  Add(new cMenuEditBoolItem(tr("Use search timers"), &data->useSearchTimers, tr("no"), tr("yes")));
  ...
  if (data->useSearchTimers)
  {
      ...
      Add(new cMenuEditIntItem(IndentMenuItem(tr("Setup.Recording$Default priority")), &data->DefPriority, 0, MAXPRIORITY));
      ...
      Add(new cMenuEditIntItem(IndentMenuItem(tr("Setup.Recording$Default lifetime (d)")), &data->DefLifetime, 0, MAXLIFETIME));
      ...
      Add(new cMenuEditIntItem(IndentMenuItem(tr("Setup.Recording$Margin at start (min)")), &data->DefMarginStart));
      ...
      Add(new cMenuEditIntItem(IndentMenuItem(tr("Setup.Recording$Margin at stop (min)")), &data->DefMarginStop));
      ...
      Add(new cMenuEditBoolItem(IndentMenuItem(tr("No announcements when replaying")), &data->noAnnounceWhileReplay, tr("no"), tr("yes")));
      ...
      Add(new cMenuEditBoolItem(IndentMenuItem(tr("Recreate timers after deletion")), &data->TimerProgRepeat, tr("no"), tr("yes")));
...
void cMenuSetupTimerConflicts::Set()
{
  ...
  Add(new cMenuEditBoolItem(tr("After each timer programming"), &data->checkTimerConflAfterTimerProg, tr("no"), tr("yes")));
  ...
  Add(new cMenuEditBoolItem(tr("When a recording starts"), &data->checkTimerConflOnRecording, tr("no"), tr("yes")));
  ...
  Add(new cMenuEditBoolItem(tr("After each search timer update"), &data->checkTimerConflictsAfterUpdate, tr("no"), tr("yes")));
  ...
  Add(new cMenuEditBoolItem(tr("Avoid notification when replaying"), &data->noConflMsgWhileReplay, tr("no"), tr("yes")));
...
void cMenuSetupMailNotification::Set()
{
  ...
  Add(new cMenuEditBoolItem(tr("Search timer notification"), &data->sendMailOnSearchtimers, tr("no"), tr("yes")));
  ...
  Add(new cMenuEditBoolItem(tr("Timer conflict notification"), &data->sendMailOnConflicts, tr("no"), tr("yes")));
  ...
  if (data->mailViaScript)
  {
     ...
     Add(new cMenuEditBoolItem(tr("Use SMTP authentication"), &data->MailUseAuth, tr("no"), tr("yes")));
