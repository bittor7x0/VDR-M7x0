...
VDR-PLUGINS_SVN_URL := http://svn.assembla.com/svn/VDR-M7x0/tags/0.7/vdr-m7x0-plugins
...
vdr_plugins_pathes = $(filter tags/0.7/%, $(CONFIG_VDR-PLUGINS)) \
   $(foreach p2, $(filter-out tags/0.7/%, $(CONFIG_VDR-PLUGINS)), $(p2))
