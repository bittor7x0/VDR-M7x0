 ...
 */
#define DEFAULT_CHARS "/abcdefghijklmnopqrstuvwxyz0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ"
...
static const char *DESCRIPTION   = tr("A simple picture viewer");
static const char *MAINMENUENTRY = tr("Pictures");
...
cMenuSetupPictures::cMenuSetupPictures(void)
{
  ...
  Add(new cMenuEditStrItem(tr("Picture directory"),    newPictureDirectory, sizeof(newPictureDirectory), DEFAULT_CHARS));
