			   ...
			   v4l2_kioctl          drv)
{
	...
	case VIDIOCSWIN: /*  set window and/or capture dimensions  */
	{
		...
		/* disable capture for sure, otherwise further calls might fail */
