...
EXPAT_URL := https://github.com/libexpat/libexpat/releases/download/$(EXPAT_RELEASE)/$(EXPAT_FILE)
...
$(STAGEFILES_DIR)/.expat_configured: $(STAGEFILES_DIR)/.expat_patched
	($(CD) $(EXPAT_DIR) ; $(UCLIBC_ENV_LIB_SIZE_LTO_GC) \
		$(EXPAT_DIR)/configure \
...
$(STAGEFILES_DIR)/.expat_compiled: $(STAGEFILES_DIR)/.expat_configured
	$(UCLIBC_ENV_LIB_SIZE_LTO_GC) $(MAKE) -C $(EXPAT_DIR)
...
$(STAGEFILES_DIR)/.expat_installed: $(STAGEFILES_DIR)/.expat_compiled
	$(UCLIBC_ENV_LIB_SIZE_LTO_GC) $(MAKE) -C $(EXPAT_DIR) install
