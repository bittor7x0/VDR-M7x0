...
ifeq ($(UCLIBC_IS_NG),y)
  ...
  ifeq ($(UCLIBC_IS_SNAPSHOT),y)
	# http://repo.or.cz/uclibc-ng.git/commit/345181fb9a36ad18c0a40ccb74bff9ee4d03819b
	UCLIBC_VERSION := 345181f
	UCLIBC_VERSION_FULL := 345181fb9a36ad18c0a40ccb74bff9ee4d03819b
