...
ifeq ($(UCLIBC_IS_NG),y)
  ...
  ifeq ($(UCLIBC_IS_SNAPSHOT),y)
	# http://repo.or.cz/uclibc-ng.git/commit/95174cb69c523a1544e5f6f20e47f7d60007e569
	UCLIBC_VERSION := 95174cb
	UCLIBC_VERSION_FULL := 95174cb69c523a1544e5f6f20e47f7d60007e569
