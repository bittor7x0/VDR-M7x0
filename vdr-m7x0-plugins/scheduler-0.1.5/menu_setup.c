...
cMenuTaskmanSetup::cMenuTaskmanSetup(void)
{
  Setup();
}

void cMenuTaskmanSetup::Setup(void)
{
  data = SchedulerConfig;
  Set();
}

void cMenuTaskmanSetup::Set()
{
  int current = Current();
  Clear();
...
void cMenuTaskmanSetup::Store(void)
{
  SchedulerConfig = data;
  SetupStore("HideMenu",  SchedulerConfig.hidemenu);
}
