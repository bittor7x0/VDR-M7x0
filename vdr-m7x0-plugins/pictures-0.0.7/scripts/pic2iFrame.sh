...
#   (- jpeg-6b: http://www.ijg.org/ <= not sure if realy needed)
#   - perl lib Image-Size: in a bash shell type
#     'sudo perl -MCPAN -e shell' then 'install Image::Size' 
#     and then 'quit' to finish
#
#  Example:
#    ./pic2iFrame.sh -a -i -v1 /home/Bilder/ /home/tmp/
#
